            ...
            <form>
                <div class="divCadastro">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="inputAddress" placeholder="xxxxxxx@xxxxx.xx">
                    </div>
                    <br>
                    <br>
                    <br>
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" id="inputAddress2" placeholder="XX.XXX-XXX">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-9">
                            <label for="inputCity">Logadouro</label>
                            <input type="text" class="form-control" id="inputCity" placeholder="Rua, Avenida...">
                        </div>
                        <div class="form-group col-md-3">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="password" class="form-control" id="inputCity" placeholder="">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputState">Confirme a senha</label>
